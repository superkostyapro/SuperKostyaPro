...
external open class FixedKeyControl(config: Phaser.Types.Cameras.Controls.FixedKeyControlConfig) {
...
external open class SmoothedKeyControl(config: Phaser.Types.Cameras.Controls.SmoothedKeyControlConfig) {
    open var camera: Camera
    open var left: Key
    open var right: Key
    open var up: Key
