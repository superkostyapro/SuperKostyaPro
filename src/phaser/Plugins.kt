...
external open class BasePlugin(pluginManager: Phaser.Plugins.PluginManager) {
...
external open class PluginManager(game: Phaser.Game) {
    open var game: Game
...
external open class ScenePlugin(scene: Phaser.Scene, pluginManager: Phaser.Plugins.PluginManager) : BasePlugin {
