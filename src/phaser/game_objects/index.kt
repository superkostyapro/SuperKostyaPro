...
external open class BitmapText : GameObject, Alpha, BlendMode, Depth, Mask, Origin, Pipeline, ScrollFactor, Phaser.GameObjects.Components.Texture, Tint, Transform, Visible {
    constructor(scene: Scene, x: Number, y: Number, font: String, text: String, size: Number, align: integer)
    constructor(scene: Scene, x: Number, y: Number, font: String, text: Array<String>, size: Number, align: integer)
...
external open class Blitter : GameObject, Alpha, BlendMode, Depth, Mask, Pipeline, ScrollFactor, Size, Phaser.GameObjects.Components.Texture, Transform, Visible {
...
external open class Container(scene: Phaser.Scene, x: Number = definedExternally, y: Number = definedExternally, children: Array<Phaser.GameObjects.GameObject> = definedExternally) : GameObject, AlphaSingle, BlendMode, ComputedSize, Depth, Mask, Transform, Visible {
...
external open class DisplayList(scene: Phaser.Scene) : List<GameObject> {
...
external open class Extern(scene: Phaser.Scene) : GameObject, Alpha, BlendMode, Depth, Flip, Origin, ScrollFactor, Size, Phaser.GameObjects.Components.Texture, Tint, Transform, Visible {
...
external open class GameObject(scene: Phaser.Scene, type: String) : EventEmitter {
    open var scene: Scene
...
external open class GameObjectCreator(scene: Phaser.Scene) {
...
external open class GameObjectFactory(scene: Phaser.Scene) {
...
external open class Graphics(scene: Phaser.Scene, options: Phaser.Types.GameObjects.Graphics.Styles /* Phaser.Types.GameObjects.Graphics.Styles & `T$5` */ = definedExternally) : GameObject, AlphaSingle, BlendMode, Depth, Mask, Pipeline, Transform, Visible, ScrollFactor {
    open var displayOriginX: Number
    open var displayOriginY: Number
...
external open class LightsPlugin(scene: Phaser.Scene) : LightsManager {
    open var scene: Scene
    open var systems: Systems
    open fun boot()
...
external open class Mesh : GameObject, BlendMode, Depth, Mask, Pipeline, Size, Phaser.GameObjects.Components.Texture, Transform, Visible, ScrollFactor {
...
external open class RenderTexture(scene: Phaser.Scene, x: Number = definedExternally, y: Number = definedExternally, width: integer = definedExternally, height: integer = definedExternally) : GameObject, Alpha, BlendMode, ComputedSize, Crop, Depth, Flip, GetBounds, Mask, Origin, Pipeline, ScrollFactor, Tint, Transform, Visible {
...
external open class Rope : GameObject, AlphaSingle, BlendMode, Depth, Flip, Mask, Pipeline, Size, Phaser.GameObjects.Components.Texture, Transform, Visible, ScrollFactor {
...
external open class Arc(scene: Phaser.Scene, x: Number = definedExternally, y: Number = definedExternally, radius: Number = definedExternally, startAngle: integer = definedExternally, endAngle: integer = definedExternally, anticlockwise: Boolean = definedExternally, fillColor: Number = definedExternally, fillAlpha: Number = definedExternally) : Shape {
...
external open class Curve(scene: Phaser.Scene, x: Number = definedExternally, y: Number = definedExternally, curve: Phaser.Curves.Curve = definedExternally, fillColor: Number = definedExternally, fillAlpha: Number = definedExternally) : Shape {
...
external open class Ellipse(scene: Phaser.Scene, x: Number = definedExternally, y: Number = definedExternally, width: Number = definedExternally, height: Number = definedExternally, fillColor: Number = definedExternally, fillAlpha: Number = definedExternally) : Shape {
    open var smoothness: integer
...
external open class IsoBox(scene: Phaser.Scene, x: Number = definedExternally, y: Number = definedExternally, size: Number = definedExternally, height: Number = definedExternally, fillTop: Number = definedExternally, fillLeft: Number = definedExternally, fillRight: Number = definedExternally) : Shape {
...
external open class Line(scene: Phaser.Scene, x: Number = definedExternally, y: Number = definedExternally, x1: Number = definedExternally, y1: Number = definedExternally, x2: Number = definedExternally, y2: Number = definedExternally, strokeColor: Number = definedExternally, strokeAlpha: Number = definedExternally) : Shape {
...
external open class Polygon(scene: Phaser.Scene, x: Number = definedExternally, y: Number = definedExternally, points: Any = definedExternally, fillColor: Number = definedExternally, fillAlpha: Number = definedExternally) : Shape {
...
external open class Rectangle(scene: Phaser.Scene, x: Number, y: Number, width: Number = definedExternally, height: Number = definedExternally, fillColor: Number = definedExternally, fillAlpha: Number = definedExternally) : Shape {
...
external open class Shape(scene: Phaser.Scene, type: String = definedExternally, data: Any = definedExternally) : GameObject, AlphaSingle, BlendMode, ComputedSize, Depth, GetBounds, Mask, Origin, Pipeline, ScrollFactor, Transform, Visible {
    open var data: Any
...
external open class Star(scene: Phaser.Scene, x: Number = definedExternally, y: Number = definedExternally, points: Number = definedExternally, innerRadius: Number = definedExternally, outerRadius: Number = definedExternally, fillColor: Number = definedExternally, fillAlpha: Number = definedExternally) : Shape {
...
external open class Triangle(scene: Phaser.Scene, x: Number = definedExternally, y: Number = definedExternally, x1: Number = definedExternally, y1: Number = definedExternally, x2: Number = definedExternally, y2: Number = definedExternally, x3: Number = definedExternally, y3: Number = definedExternally, fillColor: Number = definedExternally, fillAlpha: Number = definedExternally) : Shape {
...
external open class TextStyle(text: Phaser.GameObjects.Text, style: Phaser.Types.GameObjects.Text.TextStyle) {
...
external open class UpdateList(scene: Phaser.Scene) : ProcessQueue<GameObject> {
    open var scene: Scene
    open var systems: Systems
...
external open class Video(scene: Phaser.Scene, x: Number, y: Number, key: String = definedExternally) : GameObject, Alpha, BlendMode, Depth, Flip, GetBounds, Mask, Origin, Pipeline, ScrollFactor, Size, TextureCrop, Tint, Transform, Visible {
...
external open class Zone(scene: Phaser.Scene, x: Number, y: Number, width: Number = definedExternally, height: Number = definedExternally) : GameObject, Depth, GetBounds, Origin, Transform, ScrollFactor, Visible {
    open var width: Number
    open var height: Number
