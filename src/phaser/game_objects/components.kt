...
external interface Animation {
    ...
    fun chain(key: Animation = definedExternally): GameObject
    ...
    fun play(key: Animation, ignoreIfPlaying: Boolean = definedExternally, startFrame: integer = definedExternally): GameObject
    fun playReverse(key: String, ignoreIfPlaying: Boolean = definedExternally, startFrame: integer = definedExternally): GameObject
    fun playReverse(key: Animation, ignoreIfPlaying: Boolean = definedExternally, startFrame: integer = definedExternally): GameObject
    ...
    fun remove(key: String = definedExternally, animation: Animation = definedExternally)
