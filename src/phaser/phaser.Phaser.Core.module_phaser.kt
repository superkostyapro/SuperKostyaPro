...
external open class Config(GameConfig: Phaser.Types.Core.GameConfig = definedExternally) {
...
external open class TimeStep(game: Phaser.Game, config: Phaser.Types.Core.FPSConfig) {
    open var game: Game
