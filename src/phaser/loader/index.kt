...
external open class File(loader: Phaser.Loader.LoaderPlugin, fileConfig: Phaser.Types.Loader.FileConfig) {
...
external open class LoaderPlugin(scene: Phaser.Scene) : EventEmitter {
...
external open class MultiFile(loader: Phaser.Loader.LoaderPlugin, type: String, key: String, files: Array<Phaser.Loader.File>) {
    open var loader: LoaderPlugin
    open var type: String
    open var key: String
