...
external open class DataManager(parent: Any?, eventEmitter: Phaser.Events.EventEmitter = definedExternally) {
    open var parent: Any
...
external open class DataManagerPlugin(scene: Phaser.Scene) : DataManager {
