...
external open class Factory(world: Phaser.Physics.Matter.World) {
...
external open class Image : Phaser.GameObjects.Image, Bounce, Collision, Force, Friction, Gravity, Mass, Sensor, SetBody, Sleep, Static, Transform, Velocity, Alpha, BlendMode, Depth, Flip, GetBounds, Origin, Pipeline, ScrollFactor, Size, Texture, Tint, Phaser.GameObjects.Components.Transform, Visible {
...
external open class MatterPhysics(scene: Phaser.Scene) {
    open var scene: Scene
...
external open class Sprite : Phaser.GameObjects.Sprite, Bounce, Collision, Force, Friction, Gravity, Mass, Sensor, SetBody, Sleep, Static, Transform, Velocity, Alpha, BlendMode, Depth, Flip, GetBounds, Origin, Pipeline, ScrollFactor, Size, Texture, Tint, Phaser.GameObjects.Components.Transform, Visible {
    constructor(world: World, x: Number, y: Number, texture: String, frame: String, options: MatterBodyConfig)
    constructor(world: World, x: Number, y: Number, texture: String, frame: integer, options: MatterBodyConfig)
    open var world: World
...
external open class TileBody(world: Phaser.Physics.Matter.World, tile: Phaser.Tilemaps.Tile, options: Phaser.Types.Physics.Matter.MatterTileOptions = definedExternally) : EventEmitter, Bounce, Collision, Friction, Gravity, Mass, Sensor, Sleep, Static {
    open var tile: Tile
    open var world: World
...
external open class PointerConstraint(scene: Phaser.Scene, world: Phaser.Physics.Matter.World, options: Any? = definedExternally) {
    open var scene: Scene
    open var world: World
...
external open class World(scene: Phaser.Scene, config: Phaser.Types.Physics.Matter.MatterWorldConfig) : EventEmitter {
    open var scene: Scene
