...
external open class Image : Phaser.GameObjects.Image, Acceleration, Angular, Bounce, Debug, Drag, Enable, Friction, Gravity, Immovable, Mass, Size, Velocity, Alpha, BlendMode, Depth, Flip, GetBounds, Origin, Pipeline, ScrollFactor, Phaser.GameObjects.Components.Size, Texture, Tint, Transform, Visible {
...
external open class ArcadePhysics(scene: Phaser.Scene) {
...
external open class Sprite : Phaser.GameObjects.Sprite, Acceleration, Angular, Bounce, Debug, Drag, Enable, Friction, Gravity, Immovable, Mass, Size, Velocity, Alpha, BlendMode, Depth, Flip, GetBounds, Origin, Pipeline, ScrollFactor, Phaser.GameObjects.Components.Size, Texture, Tint, Transform, Visible {
    constructor(scene: Scene, x: Number, y: Number, texture: String, frame: String)
    constructor(scene: Scene, x: Number, y: Number, texture: String, frame: integer)
    override var body: dynamic /* Phaser.Physics.Arcade.Body | Phaser.Physics.Arcade.StaticBody */
...
external open class Body(world: Phaser.Physics.Arcade.World, gameObject: Phaser.GameObjects.GameObject) {
    open var world: World
...
external open class Factory(world: Phaser.Physics.Arcade.World) {
    open var world: World
    open var scene: Scene
...
external open class StaticBody(world: Phaser.Physics.Arcade.World, gameObject: Phaser.GameObjects.GameObject) {
    open var world: World
    open var gameObject: GameObject
    open var debugShowBody: Boolean
    open var debugBodyColor: integer
...
external open class World(scene: Phaser.Scene, config: Phaser.Types.Physics.Arcade.ArcadeWorldConfig) : EventEmitter {
    open var scene: Scene
