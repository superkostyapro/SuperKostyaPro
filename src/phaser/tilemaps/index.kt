...
external open class LayerData(config: Phaser.Types.Tilemaps.LayerDataConfig = definedExternally) {
    open var name: String
    open var x: Number
    open var y: Number
...
external open class MapData(config: Phaser.Types.Tilemaps.MapDataConfig = definedExternally) {
    open var name: String
    open var width: Number
    open var height: Number
...
external open class ObjectLayer(config: Phaser.Types.Tilemaps.ObjectLayerConfig = definedExternally) {
    open var name: String
...
external open class Tile(layer: Phaser.Tilemaps.LayerData, index: integer, x: integer, y: integer, width: integer, height: integer, baseWidth: integer, baseHeight: integer) : Alpha, Flip, Visible {
    open var layer: LayerData
...
external open class Tilemap(scene: Phaser.Scene, mapData: Phaser.Tilemaps.MapData) {
