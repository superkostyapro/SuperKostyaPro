...
external open class CanvasTexture(manager: Phaser.Textures.TextureManager, key: String, source: HTMLCanvasElement, width: integer, height: integer) : Texture {
...
external open class TextureManager(game: Phaser.Game) : EventEmitter {
    open var game: Game
    open var name: String
    open var list: Any?
