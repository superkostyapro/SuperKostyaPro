...
external open class InputManager(game: Phaser.Game, config: Any?) {
    open var game: Game
...
external open class InputPlugin(scene: Phaser.Scene) : EventEmitter {
...
external open class Pointer(manager: Phaser.Input.InputManager, id: integer) {
    open var manager: InputManager
    open var id: integer
