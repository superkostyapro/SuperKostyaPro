...
external open class Animation(manager: Phaser.Animations.AnimationManager, key: String, config: Phaser.Types.Animations.Animation) : EventEmitter {
...
external open class AnimationManager(game: Phaser.Game) : EventEmitter {
    open var game: Game
