...
open external class Matrix3(m: Phaser.Math.Matrix3 = definedExternally) {
...
open external class Matrix4(m: Phaser.Math.Matrix4 = definedExternally) {
    open var `val`: Float32Array
...
open external class RandomDataGenerator {
    ...
    constructor(seeds: Array<String>)
...
open external class Vector2 {
    ...
    constructor(x: Vector2Like, y: Number)
    open var x: Number
    open var y: Number
