...
open external class Line(x1: Number = definedExternally, y1: Number = definedExternally, x2: Number = definedExternally, y2: Number = definedExternally) {
    open var type: integer
    open var x1: Number
    open var y1: Number
    open var x2: Number
...
open external class Polygon(points: Array<Phaser.Geom.Point> = definedExternally) {
    open var type: integer
...
open external class Triangle(x1: Number = definedExternally, y1: Number = definedExternally, x2: Number = definedExternally, y2: Number = definedExternally, x3: Number = definedExternally, y3: Number = definedExternally) {
    open var type: integer
    open var x1: Number
    open var y1: Number
    open var x2: Number
