...
open external class Particle(emitter: Phaser.GameObjects.Particles.ParticleEmitter) {
...
open external class ParticleEmitter(manager: Phaser.GameObjects.Particles.ParticleEmitterManager, config: Phaser.Types.GameObjects.Particles.ParticleEmitterConfig) : BlendMode, Mask, ScrollFactor, Visible {
