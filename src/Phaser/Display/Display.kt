...
open external class Color(red: integer = definedExternally, green: integer = definedExternally, blue: integer = definedExternally, alpha: integer = definedExternally) {
...
open external class BaseShader(key: String, fragmentSrc: String = definedExternally, vertexSrc: String = definedExternally, uniforms: Any = definedExternally) {
    open var key: String
