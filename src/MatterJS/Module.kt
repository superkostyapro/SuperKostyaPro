...
external fun use(vararg plugins: Plugin)
...
open external class Composite {
    companion object {
        ...
        fun move(compositeA: CompositeType, objects: Array<dynamic /* BodyType | CompositeType | ConstraintType */>, compositeB: CompositeType): CompositeType
...
open external class CompositeFactory {
    ...
    open fun move(compositeA: CompositeType, objects: Array<dynamic /* BodyType | CompositeType | ConstraintType */>, compositeB: CompositeType): CompositeType
...
open external class Events {
    companion object {
        ...
        fun on(obj: Engine, name: String /* "beforeUpdate" */, callback: (e: IEventTimestamped<Engine>) -> Unit)
        fun on(obj: Engine, name: String /* "collisionActive" */, callback: (e: IEventCollision<Engine>) -> Unit)
        fun on(obj: Engine, name: String /* "collisionEnd" */, callback: (e: IEventCollision<Engine>) -> Unit)
        fun on(obj: Engine, name: String /* "collisionStart" */, callback: (e: IEventCollision<Engine>) -> Unit)
...
open external class Plugin {
    ...
    companion object {
        ...
        fun isFor(plugin: Plugin, module: `T$14`): Boolean
        fun use(module: `T$15`, plugins: Array<dynamic /* Plugin | String */>)
        fun dependencies(module: `T$17`, tracked: `T$16` = definedExternally): dynamic /* `T$16` | String | Nothing? */
        fun dependencies(module: `T$19`, tracked: `T$16` = definedExternally): dynamic /* `T$16` | String | Nothing? */
        fun dependencies(module: String, tracked: `T$16` = definedExternally): dynamic /* `T$16` | String | Nothing? */
        fun dependencyParse(dependency: `T$17`): `T$17`
        fun dependencyParse(dependency: `T$19`): `T$17`
        fun dependencyParse(dependency: String): `T$17`
        fun versionParse(range: String): `T$18`
